...
public class Module_04_Search extends BaseTest {
	...
	public void TC_05_Advance_Search_Parent_Categories() {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Search 05 - Step 04: Uncheck to checkbox 'Automaticlly search sub categories");
	...
	public void TC_06_Advance_Search_Sub_Categories() {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Search 06 - Step 04: check to checkbox 'Automaticlly search sub categories");
	...
	public void TC_07_Advance_Search_Incorrect_Manufacturer() {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Search 07 - Step 04: check to checkbox 'Automaticlly search sub categories");
		searchPage.checkToCheckboxByLabel(driver, "Automatically search sub categories");
	...
	public void TC_08_Advance_Search_Correct_Manufacturer() {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Search 08 - Step 04: check to checkbox 'Automaticlly search sub categories");
		searchPage.checkToCheckboxByLabel(driver, "Automatically search sub categories");
