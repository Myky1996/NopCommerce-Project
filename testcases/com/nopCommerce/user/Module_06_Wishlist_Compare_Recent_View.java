...
public class Module_06_Wishlist_Compare_Recent_View extends BaseTest {
	...
	public void TC_02_Add_To_Cart_From_WishList_Page() {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Add to cart 01 - Step 05: verify product is added to Shopping cart");
		...
		wishlistPage = PageGeneratorManager.getWishlistPage(driver);
		ExtentTestManager.getTest().log(Status.INFO, "Add to cart 01 - Step 07: verify product is removed from wishlist");
